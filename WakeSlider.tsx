...
const WakeSlider: React.FC<WakeSliderProps> = ({
  ...
  const commitFromX = (x: number) => {
    ...
    target.set(toPct(snap(nextVal, min, max, step), min, max));
    commit(nextVal);
  };
  const onPointerDown = (e: React.PointerEvent<HTMLDivElement>) => {
    ...
    document.getElementById('volumeWidget')?.classList.add('is-dragging');
  ...
  const endDrag = (e: React.PointerEvent<HTMLDivElement>) => {
    ...
    document.getElementById('volumeWidget')?.classList.remove('is-dragging');
